defmodule ImpressionerWeb.PanelLive do
  ...
  def handle_event("switch_slide", %{"code" => "ArrowLeft"}, socket) do
    Slides.prev()
    {:noreply, socket}
  end

  def handle_event("switch_slide", %{"code" => "ArrowRight"}, socket) do
    Slides.next()
    {:noreply, socket}
  end

  def handle_event("switch_slide", _key, socket) do
    {:noreply, socket}
  end
